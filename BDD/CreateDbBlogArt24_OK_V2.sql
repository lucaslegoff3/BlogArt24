...
//
// nom script : CreateDbBlogArt24_OK.sql
*/
/**********************************************************************/
/*====================================================================*/
/*
...
GRANT ALL PRIVILEGES ON `BLOGART24`.* TO 'blogArt_user'@'%' IDENTIFIED BY 'blogArt_password';;
GRANT ALL PRIVILEGES ON `BLOGART24`.* TO 'blogArt_user'@'LOCALHOST' IDENTIFIED BY 'blogArt_password';;
