                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/views/backend/statuts/list.php" class="btn btn-warning disabled">Edit</a>
                                <a href="/views/backend/statuts/list.php" class="btn btn-danger disabled">Delete</a>
                            </td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/views/backend/members/list.php" class="btn btn-warning disabled">Edit</a>
                                <a href="/views/backend/members/list.php" class="btn btn-danger disabled">Delete</a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/views/backend/articles/list.php" class="btn btn-warning disabled">Edit</a>
                                <a href="/views/backend/articles/list.php" class="btn btn-danger disabled">Delete</a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/views/backend/thematiques/list.php" class="btn btn-warning disabled">Edit</a>
                                <a href="/views/backend/thematiques/list.php" class="btn btn-danger disabled">Delete</a>
                            </td>
                            <td></td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/views/backend/comments/list.php" class="btn btn-warning">Edit</a>
                                <a href="/views/backend/comments/list.php" class="btn btn-danger">Delete</a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/views/backend/likes/list.php" class="btn btn-warning">Edit</a>
                                <a href="/views/backend/likes/list.php" class="btn btn-danger">Delete</a>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/views/backend/keywords/list.php" class="btn btn-warning disabled">Edit</a>
                                <a href="/views/backend/keywords/list.php" class="btn btn-danger disabled">Delete</a>
                            </td>
                            <td></td>
                        </tr>
                    </tbody>
